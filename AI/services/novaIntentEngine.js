...
const DEFINITIONS = Object.freeze([
  ...
  { name: 'goGameCenter', phrases: ['mo game center', 'vao khu tro choi', 'dua toi khu giai tri', 'choi game', 'mo trang games', 'vao game center'] },
  { name: 'goGravityTourist', phrases: ['mo gravity tourist', 'vao gravity tourist', 'den gravity tourist', 'choi gravity tourist'] },
  { name: 'gameCenterInfo', phrases: ['game center la gi', 'khu tro choi co gi', 'gioi thieu game center', 'co game gi', 'khu giai tri'] },
  { name: 'gravityTouristInfo', phrases: ['gravity tourist la gi', 'gioi thieu gravity tourist', 'cach choi gravity tourist', 'game nguoi ngoai hanh tinh', 'game ufo'] },
...
const NATURAL_RULES = Object.freeze([
  ...
  ['goGameCenter', /\b(?:mo|vao|den|dua|dan|choi).{0,24}\b(?:game center|khu tro choi|khu giai tri|trang games?)\b/],
  ['goGravityTourist', /^(?:mo|vao|den|dua toi|dan toi|choi)\s+(?:game\s+)?gravity tourist\b/],
  ['gravityTouristInfo', /\b(?:gravity tourist|game ufo|game nguoi ngoai hanh tinh)\b/],
  ['gameCenterInfo', /\b(?:game center|khu tro choi|khu giai tri).{0,24}\b(?:la gi|co gi|gioi thieu|game nao)\b/],
