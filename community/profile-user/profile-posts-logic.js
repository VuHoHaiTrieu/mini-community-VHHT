...
async function setInlineCommentReaction(post,comment,type="love"){
  ...
  const reactions={...(comment.commentReactions||{})};if(reactions[me.uid]===type)delete reactions[me.uid];else reactions[me.uid]=type;
